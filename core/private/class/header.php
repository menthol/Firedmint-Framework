...
class header
{
	public static $alternateContent = null;
	...
	static function setAlternateContent($content)
	{
		header::$alternateContent = $content;
	}
	
	static function getAlternateContent()
	{
		return header::$alternateContent;
	}
}